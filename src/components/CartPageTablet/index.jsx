  ...
  return (
    <div className="container-center-horizontal">
      <div className="cart-page-tablet screen">
        ...
        <div className="my-cart valign-text-middle poppins-medium-black-72px">{myCart}</div>
        <div className="ecommerce-item">
          <div className="flex-col-1">
            <div className="flex-row-1">
              <img className="image-14" src={image1} />
              <div className="desc-10 inter-normal-eerie-black-20px">{desc1}</div>
            </div>
            <div className="flex-row">
              <AddButton3 />
              <div className="quantity valign-text-middle poppins-normal-black-38px">{quantity1}</div>
              <SubstractButton3 />
              <RemoveButton3 />
              <div className="price-10 valign-text-middle inter-bold-black-24px">{price1}</div>
            </div>
          </div>
        </div>
        <div className="ecommerce-item-1">
          ...
          <div className="flex-row-3">
            <AddButton3 />
            <div className="quantity valign-text-middle poppins-normal-black-38px">{quantity2}</div>
            <SubstractButton3 />
            <RemoveButton3 />
            <div className="price-11 valign-text-middle inter-bold-black-24px">{price2}</div>
          </div>
        </div>
        <div className="ecommerce-item-2">
          <div className="flex-col-2">
            <div className="flex-row-4">
              ...
              <div className="desc-12 inter-normal-eerie-black-20px">{desc3}</div>
            </div>
            <div className="flex-row">
              <AddButton3 />
              <div className="quantity valign-text-middle poppins-normal-black-38px">{quantity3}</div>
              <SubstractButton3 />
              <RemoveButton3 className={removeButton3Props.className} />
              <div className="price-12 valign-text-middle inter-bold-black-24px">{price3}</div>
            </div>
          </div>
        </div>
        <div className="total-card">
          <div className="total-35699 valign-text-middle poppins-medium-black-26px">{total35699}</div>
        </div>
          ...
          <div className="credit-card">
            <div className="overlap-group-10">
              ...
              <div className="flex-row-7">
                <img className="master-card" src="/img/mastercard@2x.svg" />
                <Maestro />
